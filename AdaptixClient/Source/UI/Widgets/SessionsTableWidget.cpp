...
void SessionsTableWidget::handleSessionsTableMenu(const QPoint &pos)
{
    ...
    ctxMenu.addAction(tr("Set tag"), this, &SessionsTableWidget::actionItemTag);
...
void SessionsTableWidget::actionConsoleDelete()
{
    QMessageBox::StandardButton reply = QMessageBox::question(this, tr("Clear Confirmation"),
                                      ...
                                      tr("If you want to temporarily hide the contents of the agent console, do so through the agent console menu."),
...
void SessionsTableWidget::actionAgentRemove()
{
    QMessageBox::StandardButton reply = QMessageBox::question(this, tr("Delete Confirmation"),
                                      ...
                                      tr("If you want to hide the record, simply choose: 'Item -> Hide on Client'."),
                                      QMessageBox::Yes | QMessageBox::No,
                                      QMessageBox::No);
