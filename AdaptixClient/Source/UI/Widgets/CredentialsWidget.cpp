...
void CredentialsWidget::createUI()
{
    ...
    tableWidget->setHorizontalHeaderItem(ColumnTag,      new QTableWidgetItem(tr("Tag")));
    tableWidget->setHorizontalHeaderItem(ColumnDate,     new QTableWidgetItem(tr("Date")));
    tableWidget->setHorizontalHeaderItem(ColumnStorage,  new QTableWidgetItem(tr("Storage")));
    tableWidget->setHorizontalHeaderItem(ColumnAgent,    new QTableWidgetItem(tr("Agent")));
    tableWidget->setHorizontalHeaderItem(ColumnHost,     new QTableWidgetItem(tr("Host")));
...
void CredentialsWidget::handleCredentialsMenu(const QPoint &pos ) const
{
    ...
    ctxMenu.addAction(tr("Create"), this, &CredentialsWidget::onCreateCreds );
    ctxMenu.addAction(tr("Edit"),   this, &CredentialsWidget::onEditCreds );
    ctxMenu.addAction(tr("Remove"), this, &CredentialsWidget::onRemoveCreds );
    ...
    ctxMenu.addAction(tr("Set tag"), this, &CredentialsWidget::onSetTag );
    ctxMenu.addAction(tr("Export"),  this, &CredentialsWidget::onExportCreds );
