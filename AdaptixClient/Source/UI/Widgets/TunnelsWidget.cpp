...
void TunnelsWidget::createUI()
{
     ...
     tableWidget->setHorizontalHeaderItem( 0, new QTableWidgetItem(tr("Tunnel ID")));
     tableWidget->setHorizontalHeaderItem( 1, new QTableWidgetItem(tr("Agent ID")));
     tableWidget->setHorizontalHeaderItem( 2, new QTableWidgetItem(tr("Computer")));
     ...
     tableWidget->setHorizontalHeaderItem( 5, new QTableWidgetItem(tr("Type")));
     tableWidget->setHorizontalHeaderItem( 6, new QTableWidgetItem(tr("Info")));
     tableWidget->setHorizontalHeaderItem( 7, new QTableWidgetItem(tr("Interface")));
     tableWidget->setHorizontalHeaderItem( 8, new QTableWidgetItem(tr("Listen port")));
     tableWidget->setHorizontalHeaderItem( 9, new QTableWidgetItem(tr("Client")));
     tableWidget->setHorizontalHeaderItem( 10, new QTableWidgetItem(tr("Target host")));
     tableWidget->setHorizontalHeaderItem( 11, new QTableWidgetItem(tr("Target port")));
