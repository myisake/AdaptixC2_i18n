...
void TasksWidget::createUI()
{
    ...
    tableWidget->setHorizontalHeaderItem( this->ColumnTaskId,      new QTableWidgetItem(tr("Task ID")));
    tableWidget->setHorizontalHeaderItem( this->ColumnTaskType,    new QTableWidgetItem(tr("Task Type")));
    tableWidget->setHorizontalHeaderItem( this->ColumnAgentId,     new QTableWidgetItem(tr("Agent ID")));
    tableWidget->setHorizontalHeaderItem( this->ColumnClient,      new QTableWidgetItem(tr("Client")));
    tableWidget->setHorizontalHeaderItem( this->ColumnUser,        new QTableWidgetItem(tr("User")));
    tableWidget->setHorizontalHeaderItem( this->ColumnComputer,    new QTableWidgetItem(tr("Computer")));
    tableWidget->setHorizontalHeaderItem( this->ColumnStartTime,   new QTableWidgetItem(tr("Start Time")));
    tableWidget->setHorizontalHeaderItem( this->ColumnFinishTime,  new QTableWidgetItem(tr("Finish Time")));
