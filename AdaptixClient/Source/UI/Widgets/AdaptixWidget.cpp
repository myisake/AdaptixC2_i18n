...
void AdaptixWidget::LoadConsoleUI(const QString &AgentId)
{
    ...
    if (agent && agent->Console) {
        auto text = QString(tr("Console [%1]")).arg( AgentId );
...
void AdaptixWidget::LoadTasksOutput() const { this->AddTab(TasksTab->taskOutputConsole, tr("Task Output"), ":/icons/job"); }
...
void AdaptixWidget::LoadFileBrowserUI(const QString &AgentId)
{
    ...
    if (agent && agent->FileBrowser) {
        auto text = QString(tr("Files [%1]")).arg( AgentId );
...
void AdaptixWidget::LoadProcessBrowserUI(const QString &AgentId)
{
    ...
    if (agent && agent->ProcessBrowser) {
        auto text = QString(tr("Processes [%1]")).arg( AgentId );
...
void AdaptixWidget::LoadTerminalUI(const QString &AgentId)
{
    ...
    if (agent && agent->Terminal) {
        auto text = QString(tr("Terminal [%1]")).arg( AgentId );
...
void AdaptixWidget::SetTasksUI() const
{
    ...
    this->AddTab(TasksTab->taskOutputConsole, tr("Task Output"), ":/icons/job");
}

void AdaptixWidget::LoadAxConsoleUI() const { this->AddTab(AxConsoleTab, tr("AxScript Console"), ":/icons/code_blocks"); }

void AdaptixWidget::LoadLogsUI() const { this->AddTab(LogsTab, tr("Logs"), ":/icons/logs"); }

void AdaptixWidget::LoadListenersUI() const { this->AddTab(ListenersTab, tr("Listeners"), ":/icons/listeners"); }

void AdaptixWidget::LoadTunnelsUI() const { this->AddTab(TunnelsTab, tr("Tunnels"), ":/icons/vpn"); }

void AdaptixWidget::LoadDownloadsUI() const { this->AddTab(DownloadsTab, tr("Downloads"), ":/icons/downloads"); }

void AdaptixWidget::LoadScreenshotsUI() const { this->AddTab(ScreenshotsTab, tr("Screenshots"), ":/icons/picture"); }

void AdaptixWidget::LoadCredentialsUI() const { this->AddTab(CredentialsTab, tr("Credentials"), ":/icons/key"); }

void AdaptixWidget::LoadTargetsUI() const { this->AddTab(TargetsTab, tr("Targets"), ":/icons/devices"); }
