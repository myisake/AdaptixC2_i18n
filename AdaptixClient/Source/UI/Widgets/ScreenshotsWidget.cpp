...
ScreenshotsWidget::ScreenshotsWidget(AdaptixWidget* w) : DockTab(tr("Screenshots"), w->GetProfile()->GetProject(), ":/icons/picture")
{
...
void ScreenshotsWidget::createUI()
{
    ...
    tableWidget->setHorizontalHeaderItem( 1, new QTableWidgetItem( tr("User") ) );
    tableWidget->setHorizontalHeaderItem( 2, new QTableWidgetItem( tr("Computer") ) );
    tableWidget->setHorizontalHeaderItem( 3, new QTableWidgetItem( tr("Note") ) );
    tableWidget->setHorizontalHeaderItem( 4, new QTableWidgetItem( tr("Date") ) );
...
void ScreenshotsWidget::actionDownload() const
{
    ...
    NonBlockingDialogs::getSaveFileName(const_cast<ScreenshotsWidget*>(this), tr("Save File"), "screenshot.png", "All Files (*.*)",
